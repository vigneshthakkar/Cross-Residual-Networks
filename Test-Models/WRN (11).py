...
weights={
    ...
    'conva': tf.Variable(tf.random_normal([1,1,320,320])),
    'fc': tf.Variable(tf.random_normal([704,10]))
}
...
biases={
    ...
    'conva': tf.Variable(tf.random_normal([320])),
