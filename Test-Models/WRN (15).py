...
weights={
    ...
    'conv3': tf.Variable(tf.random_normal([3,3,128,64])),
    'conv4': tf.Variable(tf.random_normal([3,3,192,64])),
    'conv5': tf.Variable(tf.random_normal([3,3,256,64])),
    'conv6': tf.Variable(tf.random_normal([3,3,320,64])),
    'conv7': tf.Variable(tf.random_normal([3,3,384,64])),
    'conv8': tf.Variable(tf.random_normal([3,3,448,64])),
    'conv9': tf.Variable(tf.random_normal([3,3,512,64])),
    'conv10': tf.Variable(tf.random_normal([3,3,576,64])),
    'conv11': tf.Variable(tf.random_normal([3,3,640,64])),
    'conv12': tf.Variable(tf.random_normal([3,3,704,64])),
    'conv13': tf.Variable(tf.random_normal([3,3,768,64])),
    'conv14': tf.Variable(tf.random_normal([3,3,832,64])),
    'conv15': tf.Variable(tf.random_normal([3,3,896,64])),
    'conva': tf.Variable(tf.random_normal([3,3,448,448])),
    'fc': tf.Variable(tf.random_normal([960,10]))
}
...
biases={
    ...
    'conva': tf.Variable(tf.random_normal([448])),
