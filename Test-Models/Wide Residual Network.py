...
weights={
    ...
    'conv': tf.Variable(tf.random_normal([3,3,192,192])),
    'fc': tf.Variable(tf.random_normal([448,10]))
}
...
biases={
    ...
    'conv': tf.Variable(tf.random_normal([192])),
...
with tf.Session() as sess:
    ...
    epochs=50
    batchsize=100
    print('Model 3 : Wide Residual Network')
