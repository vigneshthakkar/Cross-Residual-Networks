...
weights={
    ...
    'conv3': tf.Variable(tf.random_normal([3,3,16,16])),
    'conv4': tf.Variable(tf.random_normal([3,3,32,16])),
    'conv5': tf.Variable(tf.random_normal([3,3,32,16])),
    'conv6': tf.Variable(tf.random_normal([3,3,48,16])),
    'conv7': tf.Variable(tf.random_normal([3,3,48,16])),
    'conva': tf.Variable(tf.random_normal([1,1,16,16])),
    'convb': tf.Variable(tf.random_normal([1,1,32,32])),
    'fc': tf.Variable(tf.random_normal([64,10]))
}
...
biases={
    ...
    'conva': tf.Variable(tf.random_normal([16])),
    'convb': tf.Variable(tf.random_normal([32])),
...
def net():
    ...
    conv4=concat(conv4,conva)
    conv5=conv(conv4,weights['conv5'],biases['conv5'],1)
    conv5=concat(conv5,convb)
...
with tf.Session() as sess:
    ...
    epochs=50
    batchsize=100
    print('Model 2 : Cross Residual Network')
