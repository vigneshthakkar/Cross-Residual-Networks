...
weights={
    ...
    'conv12': tf.Variable(tf.random_normal([3,3,192,64])),
    'conv13': tf.Variable(tf.random_normal([3,3,192,64])),
    'conv14': tf.Variable(tf.random_normal([3,3,256,64])),
    'conv15': tf.Variable(tf.random_normal([3,3,256,64])),
    'conva': tf.Variable(tf.random_normal([3,3,64,64])),
    'convb': tf.Variable(tf.random_normal([3,3,128,128])),
    'convc': tf.Variable(tf.random_normal([3,3,128,128])),
    'convd': tf.Variable(tf.random_normal([3,3,128,128])),
    'fc': tf.Variable(tf.random_normal([256,10]))
}
...
biases={
    ...
    'convc': tf.Variable(tf.random_normal([128])),
...
def net():
    ...
    conv6=concat(conv6,conv2)
    convc=conv(conv6,weights['convc'],biases['convc'],2)
    conv7=conv(conv6,weights['conv7'],biases['conv7'],1)
    conv7=concat(conv7,conv3)
    convd=conv(conv7,weights['convd'],biases['convd'],2)
