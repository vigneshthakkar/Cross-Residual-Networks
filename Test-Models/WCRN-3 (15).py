...
weights={
    ...
    'conv8': tf.Variable(tf.random_normal([3,3,192,64])),
    'conv9': tf.Variable(tf.random_normal([3,3,192,64])),
    'conv10': tf.Variable(tf.random_normal([3,3,192,64])),
    'conv11': tf.Variable(tf.random_normal([3,3,256,64])),
    'conv12': tf.Variable(tf.random_normal([3,3,256,64])),
    'conv13': tf.Variable(tf.random_normal([3,3,256,64])),
    'conv14': tf.Variable(tf.random_normal([3,3,320,64])),
    'conv15': tf.Variable(tf.random_normal([3,3,320,64])),
    'conva': tf.Variable(tf.random_normal([3,3,128,128])),
    'convb': tf.Variable(tf.random_normal([3,3,128,128])),
    'convc': tf.Variable(tf.random_normal([3,3,192,192])),
    'fc': tf.Variable(tf.random_normal([320,10]))
}
...
biases={
    ...
    'convb': tf.Variable(tf.random_normal([128])),
    'convc': tf.Variable(tf.random_normal([192])),
...
def net():
    ...
    conv4=concat(conv4,conv1)
    conv5=conv(conv4,weights['conv5'],biases['conv5'],1)
    conv5=concat(conv5,conv2)
    conva=conv(conv5,weights['conva'],biases['conva'],2)
    conv6=conv(conv5,weights['conv6'],biases['conv6'],1)
    conv6=concat(conv6,conv3)
    convb=conv(conv6,weights['convb'],biases['convb'],2)
    conv7=conv(conv6,weights['conv7'],biases['conv7'],1)
    conv7=concat(conv7,conv4)
    convc=conv(conv7,weights['convc'],biases['convc'],2)
